...
DisplayTaskList.propTypes = {
  ...
  task_lists: PropTypes.array.isRequired,
  taskEdit: PropTypes.func.isRequired,
  handleSaveTask: PropTypes.func.isRequired,
  getRoadmapStatus: PropTypes.func.isRequired,
  displayAddTask: PropTypes.func.isRequired,
  ...
  isChecklistOpen: PropTypes.func.isRequired,
  isFilterOpen: PropTypes.func.isRequired,
  isSummaryOpen: PropTypes.func.isRequired,
  ...
  TaskShow: PropTypes.bool.isRequired,
  list_id: PropTypes.number.isRequired,
  deleteTaskList: PropTypes.func.isRequired,
  editTaskList: PropTypes.func.isRequired,
  deleteTlt: PropTypes.func.isRequired,
  projectTaskList: PropTypes.array.isRequired,
  switchTask: PropTypes.func.isRequired,
  switchTask2: PropTypes.func.isRequired,
  ...
  isFilterLoading: PropTypes.bool.isRequired,
  loadTaskListTaskData: PropTypes.func.isRequired,
  isTaskListTasksLoading: PropTypes.bool.isRequired,
  worksapceMembers:PropTypes.array,
  taskStatus: PropTypes.array.isRequired,
  categories: PropTypes.array.isRequired,
  memeberSelected: PropTypes.func,
  ...
  deleteUserstoryTask: PropTypes.func.isRequired,
  fetchUserstory: PropTypes.func.isRequired,
  isUserStoryLoading: PropTypes.bool.isRequired,
  ...
  userstoryUpdateTask: PropTypes.bool.isRequired,
  ...
  handleUpdatedTask: PropTypes.func.isRequired,
  showUserstoryTasks: PropTypes.func.isRequired,
  currentUserstoryTask: PropTypes.array.isRequired,
  handleUpdatedData: PropTypes.func.isRequired,
  checklistItem: PropTypes.number,
  handleTaskC: PropTypes.func.isRequired,
  newChecklist: PropTypes.bool.isRequired,
  action: PropTypes.number,
  usestoryMoveToDashboard: PropTypes.func.isRequired,
  addTaskLoading: PropTypes.func.isRequired,
}
